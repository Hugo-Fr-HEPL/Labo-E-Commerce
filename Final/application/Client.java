            ...
            if(rep.getCode()==301)
            {
                ...
                else
                {
                    ...
                    if(rep.getcodegraph()==ReponseSUM.HISTOGRAM)
                    {
                        ...
                        jFreeChart.ShowHistogram("Reg - Histogram", "Distance", "Années", histoDouble, histoString);
                    }
                    else
                    {
                        ...
                        jFreeChart.ShowHistogramComp("Reg - Histogram", "Distance", "Années", histoString, vecmois, values);
                    }
                }
            }
            else
