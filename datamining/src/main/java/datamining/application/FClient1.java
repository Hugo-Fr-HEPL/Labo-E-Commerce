...
public class FClient1 extends javax.swing.JFrame {
    ...
    private void BValiderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BValiderActionPerformed
        ...
        Client.Statistics(Integer.parseInt(LMois.getSelectedItem().toString().substring(0,tmp)), LCompagnie.getSelectedItem().toString(), LRequete.getSelectedItem().toString(), CheckBoxAges.isSelected());
    ...
    private void LRequeteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LRequeteActionPerformed
        ...
        {
            CheckBoxNbAccompagnants.setSelected(true);
